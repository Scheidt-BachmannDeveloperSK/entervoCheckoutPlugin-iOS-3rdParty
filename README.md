...
* download the <a href="https://api-developer.scheidt-bachmann.net/checkout/plugin/examples/ios/3rdpartydemo.zip">Sample Project using a 3rd Party PSP (handled by you)</a>  
